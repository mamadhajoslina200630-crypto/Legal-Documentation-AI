...
engine = create_engine(
    ...
    pool_pre_ping=True if not settings.db.url.startswith("sqlite") else False,
)
...
def init_db() -> None:
    ...
    try:
        ...
        logger.warning("The application will continue to run, but database features will fail.")
